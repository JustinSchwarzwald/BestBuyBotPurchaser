...
def login():
    #LOGIN NOW 90 SECS
    driver.find_element_by_id("fld-e").send_keys("xxxx@gmail.com")
    driver.find_element_by_id("fld-p1").send_keys("xxxxxx")
...
def checkInStock():
    ...
    global elem
    global driver
    driver.get("https://www.bestbuy.com/site/msi-nvidia-geforce-rtx-3070-ventus-3x-oc-bv-8gb-gddr6-pci-express-4-0-graphics-card-black/6438278.p?skuId=6438278")
